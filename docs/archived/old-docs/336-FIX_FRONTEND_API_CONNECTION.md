...
Phải là:
```env
NEXT_PUBLIC_GRAPHQL_ENDPOINT=http://116.118.49.243:13001/graphql  # ✅ ĐÚNG
NEXT_PUBLIC_BACKEND_URL=http://116.118.49.243:13001                # ✅ ĐÚNG
```

## ✅ Giải Pháp Đã Áp Dụng

### 1. Tạo file `.env.local` cho Tazagroup
...
# Next.js Frontend - Tazagroup Domain (13xxx ports)
...
1. Mở trình duyệt: http://116.118.49.243:13000
...
# Phải thấy header:
Access-Control-Allow-Origin: http://116.118.49.243:13000
```
...
3. **Kiểm tra file .env.local:**
   ...
   # Phải thấy: NEXT_PUBLIC_GRAPHQL_ENDPOINT=http://116.118.49.243:13001/graphql
   ```
...
- ✅ `frontend/.env.local` - Config Tazagroup
