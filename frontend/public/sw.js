// Service Worker for Katacore PWA
// Version: 1.0.0

const CACHE_VERSION = 'katacore-v1.0.0';
...
const BACKGROUND_SYNC_TAG = 'katacore-background-sync';
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(
    self.registration.showNotification('Katacore', options)
  );
});
...
async function initIndexedDB() {
  return new Promise((resolve, reject) => {
    const request = indexedDB.open('KatacoreOfflineDB', 1);
