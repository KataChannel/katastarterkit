...
function DraggableElement({ element }: { element: ElementConfig }) {
  ...
  return (
    <div
      ...
      {...attributes}
      style={style}
      className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 hover:border-primary cursor-grab active:cursor-grabbing transition-colors"
    >
