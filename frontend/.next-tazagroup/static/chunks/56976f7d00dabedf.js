(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,261877,e=>{"use strict";var i=e.i(44990),t=e.i(403055);let a=()=>{var e,a;let r,[o,n]=(0,t.useState)("product-grid"),s={"product-grid":{data:{title:"Featured Products 🛍️",subtitle:"Check out our amazing collection",products:[{id:1,name:"MacBook Pro",price:"$1,999",rating:5},{id:2,name:"iPhone 15",price:"$1,099",rating:5},{id:3,name:"AirPods Pro",price:"$249",rating:4}]},template:`
<style>
