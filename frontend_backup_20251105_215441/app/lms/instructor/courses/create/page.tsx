...
import { CREATE_COURSE, GET_MY_COURSES, GET_COURSE_CATEGORIES } from '@/graphql/lms/courses.graphql';
...
export default function CreateCoursePage() {
  ...
  const [createCourse, { loading }] = useMutation(CREATE_COURSE, {
    ...
    onCompleted: (data) => {
      router.push(`/lms/instructor/courses/${data.createCourse.id}/edit`);
    },
    onError: (error) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Bắt đầu xây dựng khóa học của bạn</p>
              </div>
            </div>
            <button
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Bạn sẽ học được gì? <span className="text-gray-500">(Mỗi dòng 1 mục)</span>
                </label>
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    placeholder="Ví dụ: Xây dựng ứng dụng web hoàn chỉnh với React..."
                  />
                  <button
                    type="button"
                    onClick={() => {
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Yêu cầu <span className="text-gray-500">(Tùy chọn)</span>
                </label>
                <div className="flex gap-2 mb-3">
                  <input
                    type="text"
                    ...
                    className="flex-1 px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Ví dụ: Kiến thức cơ bản về HTML, CSS..."
                  />
                  <button
                    type="button"
                    onClick={() => {
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="Ví dụ: Người mới bắt đầu học lập trình web..."
                  />
                  <button
                    type="button"
                    onClick={() => {
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">{formData.metaTitle.length}/200</p>
              </div>
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500">{formData.metaDescription.length}/500</p>
              </div>
