# Tính năng Quản lý Công việc (Todos) - KataCore

## Tổng quan

Tính năng Todos trong KataCore cung cấp một hệ thống quản lý công việc đầy đủ với các tính năng hiện đại như:
