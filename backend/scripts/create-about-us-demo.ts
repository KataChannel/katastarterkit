  ...
  try {
    ...
    const aboutUsPage = await prisma.page.create({
      data: {
        ...
        status: 'PUBLISHED',
        seoTitle: 'About Us - KataCore Enterprise Kit',
        ...
        blocks: {
          create: [
                  ...
                  <div class="max-w-4xl mx-auto py-16 px-4">
                    ...
                    <div class="prose prose-lg mx-auto">
                      <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        Founded in 2020, KataCore emerged from a simple yet powerful vision: to bridge the gap between 
            ...
            // 4. Team Section
            {
              ...
              content: {
                title: 'Meet Our Team',
                subtitle: 'The brilliant minds behind KataCore\'s success',
                members: [
                  {
                    name: 'Alex Johnson',
