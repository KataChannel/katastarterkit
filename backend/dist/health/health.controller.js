...
const minio_health_1 = require("./minio.health");
const logger_service_1 = require("../logger/logger.service");
let HealthController = class HealthController {
    constructor(health, http, disk, memory, prismaHealth, redisHealth, minioHealth, logger) {
        this.health = health;
        this.http = http;
        this.disk = disk;
        this.memory = memory;
...
exports.HealthController = HealthController = __decorate([
    ...
    __metadata("design:paramtypes", [terminus_1.HealthCheckService,
        ...
        minio_health_1.MinioHealthIndicator,
